...
node_3_ip=$(getent hosts redis-cluster-node-3 | awk '{ print $1 }') # New node
node_4_ip=$(getent hosts redis-cluster-node-4 | awk '{ print $1 }') # New node
node_5_ip=$(getent hosts redis-cluster-node-5 | awk '{ print $1 }') # New node
